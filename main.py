    ...
    try:
        ...
        if '/start' in msgText:
            ...
            #    
                # set in debug
            #    api_id = 15189129
            #    api_hash = 'de8ec76f2adb8fc167a67db215ec5fd1'
            #    bot_token = '5205148666:AAHzDy7WjN3SN9rIGEWxz5IhffSLgi4rFDs'
...
def main():
    ...
    #set in debug
    bot_token = '5152665787:AAGfQ40meP83zO89EJCvcBGpY_FGdINSdak'
